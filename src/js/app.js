...
$(window).on('load', function () {
    ...
    (function () {
        ...
        var countInterval = setInterval(function () {
            if (time <= 0) {
                ...
                $buttonWithCounter.removeAttr('disabled').html('Отправить код повторно');
    ...
    function initPhoneMask() {
        ...
        var startVal = '+7';
        var startValArray = startVal.split('');
        ...
        $('[data-mask=phone]').on('keyup', function (e) {
            var formattedVal = phoneMaskInput.getFormattedValue();
            var rawVal = phoneMaskInput.getRawValue();
    ...
    $('[data-required][data-maxlength][data-type="confirmation-code"]').on('keydown', function (e) {
        ...
        if ((code < 48 || code > 57 && code < 96 || code > 105) && code != 8 && code != 46 && code != 37 && code != 39 && code != 13) {
            return false;
        }
    });
